...
Route::middleware(['translations', 'cache.headers:public;max_age=2628000;etag', 'auth'])->group(function() {
    ...
    Route::get('/settings', 'App\Http\Controllers\Views\SettingsController@index')->middleware(['bans']);
...
Route::middleware(['translations', 'cache.headers:public;max_age=2628000;etag'])->group(function() {
	...
	Route::get('/', 'App\Http\Controllers\Views\HomeController@index')->middleware(['bans']);
...
Route::get('/banned', 'App\Http\Controllers\Views\HomeController@banned');
